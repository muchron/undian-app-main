...
@include('admin.contents.peserta_grandprice.custom.styles')
@section('title')
    Peserta Grand Price
@endsection
@section('content')
                ...
                <div class="card accordion-item">
                    <h2 class="accordion-header">
                        <button type="button" class="accordion-button" data-bs-toggle="collapse"
                            ...
                            Import Data Peserta Grand Price
                        </button>
                    </h2>
                            ...
                            <form id="importdata">
                                ...
                                <div class="form-group mt-2">
                                    <button onclick="importFile()" id="btn-import" type="button" class="btn btn-primary btn-sm">
                                        <span class="bx bx-import"></span> Import Data Peserta Grand Price
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Peserta Grand Price</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        {!! $dataTable->table([
                            'id' => 'pesertagrandprice-table',
    ...
    @include('admin.contents.peserta_grandprice.modals.nomor_undian_peserta_grandprice')
@endsection
@include('admin.contents.peserta_grandprice.custom.scripts')
