...
@include('admin.contents.peserta_umum_lima.custom.styles')
@section('title')
    Peserta Umum Lima
@endsection
@section('content')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Peserta Umum Lima</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        {!! $dataTable->table([
                            'id' => 'pesertaumumlima-table',
    ...
    @include('admin.contents.peserta_umum_lima.modals.nomor_undian_peserta')
@endsection
@include('admin.contents.peserta_umum_lima.custom.scripts')
