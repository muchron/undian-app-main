...
class PesertaUndianUmumLimaCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:peserta-umum-lima';
     ...
     * @var string
     */
    protected $description = 'Membuat nomor undian peserta umum lima';
    ...
    {
        PesertaUmumLima::chunk(500, function ($peoples) {
        ...
        $this->info('Undian peserta umum lima berhasil di buat');
    }
}
