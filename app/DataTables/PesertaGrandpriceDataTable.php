...
class PesertaGrandpriceDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($query) {
                return view('admin.contents.peserta_grandprice.actions.buttons', compact('query'));
            });
    }
     ...
     *
     * @param \App\Models\PesertaGrandPrice $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PesertaGrandPrice $model)
    {
    ...
    {
        return $this->builder()
                    ->setTableId('pesertagrandprice-table')
    ...
    {
        return 'PesertaGrandprice_' . date('YmdHis');
    }
}
