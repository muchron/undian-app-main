...
class PemenangUndianGrandpriceDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\PemenangUndianGrandprice $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PemenangUndianGrandprice $model)
    {
    ...
    {
        return $this->builder()
                    ->setTableId('pemenangundiangrandprice-table')
    ...
    {
        return 'PemenangUndianGrandprice_' . date('YmdHis');
    }
}
