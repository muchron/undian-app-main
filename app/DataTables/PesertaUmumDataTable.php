...
class PesertaUmumDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($query) {
                return view('admin.contents.peserta_umum.actions.buttons', compact('query'));
            });
    }
     ...
     *
     * @param \App\Models\PesertaUmum $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PesertaUmum $model)
    {
    ...
    {
        return 'PesertaUmum_' . date('YmdHis');
    }
}
